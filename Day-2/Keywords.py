...
# Keword is piller for python programing :--
# Follwing are imp keywords for devops :----

# and, or, not, if, else, elif, while, for,  in, try, except, finally,
# def, return, class, import,  from,  as, True, False, None, is,  lambda,
